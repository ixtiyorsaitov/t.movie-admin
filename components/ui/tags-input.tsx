      ...
      async (e: React.KeyboardEvent<HTMLInputElement>) => {
        ...
        switch (e.key) {
          ...
          case "Enter":
            ...
            e.stopPropagation(); // event yuqoriga ketmasin
            if (inputValue.trim() !== "") {
    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-1 p-1 rounded-lg dark:bg-input/30 bg-transparent border border-input overflow-hidden ring-1 ring-muted  ",
            {
        ...
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative px-1 rounded-sm bg-accent border-input flex items-center gap-1 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground truncate aria-disabled:opacity-50 aria-disabled:cursor-not-allowed"
              )}
              variant={"secondary"}
            >
          ...
          <Input
            ...
            className={cn(
              "outline-0 !bg-transparent border-none h-7 min-w-fit flex-1 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0 placeholder:text-muted-foreground px-1",
