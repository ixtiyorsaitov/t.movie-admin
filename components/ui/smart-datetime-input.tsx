...
// /**
//  * Utility function that parses dates and validates they are in the future.
...
//  * @returns A `Date` object representing the parsed date and time, or `null` if the string could not be parsed or is in the past.
//  */
// export const parseDateTime = (str: Date | string, locale: Locale) => {
//   if (str instanceof Date) {
//     const now = new Date();
//     return str > now ? str : null;
//   }
...
//   const parsedDate = chrono[localeCode].parseDate(str);
...
// const isTimeInFuture = (hour: number, minutes: number): boolean => {
//   const now = new Date();
...
//   return true; // For future dates, all times are valid
// };
...
//       const minutes = partStamp === 0 ? 0 : timestamp * partStamp;

//       const selectedDate = value ?? new Date();
//       const isToday = selectedDate.toDateString() === new Date().toDateString();

//       if (isToday && !isTimeInFuture(hour, minutes)) {
...
//         let hour = Number.parseInt(timeValue.split(":")[0]);
//         const minutes = Number.parseInt(timeValue.split(":")[1].split(" ")[0]);
...
//     },
//     [formateSelectedTime, hour12, value]
//   );
...
//               const isDisabled = isToday && !isTimeInFuture(i, minutes);
...
//                   )}
//                   onClick={() =>
//                     !isDisabled && handleClick(i, part, PM_AM, trueIndex)
//                   }
